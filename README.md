...
### **Reminders are fully remade, see [RoboBottom Github Repository](https://github.com/TheCreatorrr333/RoboBottom)**. They will not be added to this bot, use that bot instead.
