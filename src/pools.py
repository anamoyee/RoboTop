...
dm = {
  "swears": [" ass ", "dumbass", "asshole", "shit", "bitch", "fuck", "cunt", "damn", "dammit", " hell ", "mudblood", "frick", " heck", " peck", "crap", "piss", "fuk", "fucc", "boob", "dick", "penis", "vagina", "pussy", "ploopy", "🐬", "juniden", "nft", "tranny", "whore"],
  "nwords": ["nigger", "nigga", "niggy", "nibba", "ni:b::b:a", "nigg"],
...
spellcheck = {
  ...
  "alot": ["it's spelt **a lot**, not **alot**. Remember, you don't spell it \"alittle!\"", "it's spelt **a lot**, not **alot**. Imagine a parking lot between the two words!", "it's spelt **a lot**, not **alot**. Remember, lot is a noun!"],
  "aswell": ["it's spelt **as well**, not **aswell**. Try substituting \"well\" with a name!", "it's spelt **as well**, not **aswell**. Remember, you're comparing something to \"well\"!"],
